...
- [Arbeide med lister og biblioteker i SharePoint](#arbeide-med-lister-og-biblioteker-i-sharepoint)
  - [Innhold](#innhold)
  - [Listemenyen, når du ikke har valgt et element](#listemenyen-når-du-ikke-har-valgt-et-element)
  - [Listemenyen, når et element er valgt](#listemenyen-når-et-element-er-valgt)
  - [Bruk ellipsemenyen med listeelementer](#bruk-ellipsemenyen-med-listeelementer)
  - [Bruk ellipsemenyen med dokumenter](#bruk-ellipsemenyen-med-dokumenter)
...
7.  Med **Arbeidsflyter** kan du enkelt opprette en ny Flyt relatert til listen du står i. Man kan også lett komme seg til en oversikt over sine Flyter for å kunne jobbe videre med disse.
...
7.  Med **Integrer** kan du kjøre regler som allerede er knyttet til listen, eller du kan opprette nye
...
| **Integrer**                      | Aksjoner knyttet til Flyt på det aktuelle elementet       |
