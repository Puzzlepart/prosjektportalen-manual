...
1. Trykk på **Legg til nytt element** for å opprette nytt element.
2. De elementer som er av betydning for andre prosjekter, kan gjøres tilgjengelig for porteføljenivået ved å slå på bryteren **Vis i portefølje = Ja**. Hvis man velger å vise analysen på porteføljenivå, blir informasjonen som legges i denne lista, eller i gevinstoppfølging, synlig i gevinstoversikten på porteføljenivå. Der er den tilgjengelig for alle som har tilgang til prosjektområdet.
